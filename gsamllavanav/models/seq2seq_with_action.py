...
class Seq2SeqwithAction(nn.Module):
    ...
    def __init__(
        ...
        self.action_prediction_head = CategoricalNet(self.state_encoder.hidden_size, 4)
    ...
    def forward(
        ...
        pred_actions = self.action_prediction_head(x)
        pred_progress = self.progress_prediction_head(x)

        return pred_actions, pred_progress, rnn_states_out
