    ...
    def _diagnostics(
        ...
        with torch.no_grad():
            ...
            return {
                ...
                "stop_contrast_skip_reason": skip_reason,
                ...
                "stop_contrast_local_skip_reason": skip_reason,
